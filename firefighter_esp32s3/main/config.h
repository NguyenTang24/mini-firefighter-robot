...
#define ENCODER_L_B_GPIO    21
#define ENCODER_R_A_GPIO    38
#define ENCODER_R_B_GPIO    39
#define USE_ENCODERS         1    // 0 = timed turns, 1 = encoder turns
#define ENCODER_PPR         20    // slots on the IR encoder disk
#define WHEEL_DIAMETER_MM   67
#define WHEELBASE_MM       146    // center to center in mm
...
#define FWD_SPEED_PCT       85    // straight drive speed 0-100
#define KICK_PCT           100    // startup burst PWM to break stiction
#define KICK_MS            100    // how long the burst lasts
#define MOTOR_L_TRIM         0    // left motor trim to fix drift (-10 to +10)
#define MOTOR_R_TRIM        -3    // right motor trim
#define TURN_SPEED_PCT      65    // turn speed
#define TURN_90_MS        1800    // 90 degree turn time when USE_ENCODERS=0
...
#define SPEED_CTRL_KP         2   // proportional gain
#define SPEED_CTRL_MAX_CORR  25   // max PWM correction per cycle
#define SPEED_CTRL_DEADBAND   3   // ignore encoder errors smaller than this
...
#define SPRAY_DURATION_MS 2000    // pump on time in ms
#define FLAME_THRESHOLD    2000   // ADC reading that means flame detected
#define FLAME_CONFIRM_MS   300    // flame must read high for this long

// Landmark detection
#define MIN_LM_PIXEL_SIZE   500   // min pixel count to trigger a turn
#define LM_CONFIRM_FRAMES     2   // consecutive frames needed to confirm landmark

// Navigation
#define LM_COOLDOWN_MS      1000  // ignore landmarks this long after a turn
#define NAV_BEAR_TOL        0.10f // bearing error small enough to go straight
#define STEER_ADJUST_PCT      20  // how hard to correct bearing
...
#define FIRE_APPROACH_SPEED       40
#define FSM_BEAR_TOL            0.12f
#define FSM_STEER_GAIN            15
#define FIRE_APPROACH_TIMEOUT_MS  15000
...
#define LM_PINK     2
#define LM_YELLOW   3
#define LM_PURPLE   4   // center room, triggers DONE
#define LM_NONE    -1

// Path: orange -> pink -> yellow -> purple (center)
#define LANDMARK_SEQUENCE_LEN  4
static const int LANDMARK_SEQUENCE[LANDMARK_SEQUENCE_LEN] = {
    LM_ORANGE, LM_PINK, LM_YELLOW, LM_PURPLE
};
